...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (user_Username.contains("none")) {
            ...
            dbAccessMain.open();
            dbAccessMain.insertStudentData("enalcantara", "201501827");
            dbAccessMain.close();
    ...
    public void broadcastManually (View view) {
        if(isBroadcasting){
            Toast.makeText(this, "Already broadcasting.", Toast.LENGTH_SHORT).show();
        } else {
            isBroadcasting = true;
