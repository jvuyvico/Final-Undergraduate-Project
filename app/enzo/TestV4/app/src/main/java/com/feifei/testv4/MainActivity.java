...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Thread(new Runnable(){
            @Override
            public void run() {
                boolean alarmUp = (PendingIntent.getBroadcast(com.feifei.testv4.MainActivity.this, 20, new Intent(com.feifei.testv4.MainActivity.this, AlarmReceiver.class), PendingIntent.FLAG_NO_CREATE) != null);
                if (alarmUp){
                    Log.d("Alarm: ", "Alarm is already active");
                } else {
                    AlarmSetter alarmSetter = new AlarmSetter(com.feifei.testv4.MainActivity.this , 20);
                    Calendar calendar = Calendar.getInstance();
                    calendar.set(Calendar.SECOND, calendar.get(Calendar.SECOND)+30);
                    Intent intenttopass = new Intent(com.feifei.testv4.MainActivity.this, AlarmReceiver.class);
        ...
        classesToday_AL = com.feifei.testv4.Utils.getClassesToday(this);
        ...
        for (int i = 0; i<classesToday_AL.size(); i++) {
            boolean classAlarmUp = (PendingIntent.getBroadcast(this, i, new Intent(this, com.feifei.testv4.ClassAlarmReceiver.class), PendingIntent.FLAG_NO_CREATE) != null);
            if(classAlarmUp){
                alarmcounter++;
            }
        }
        ...
        if (!sharedPreferences.contains("initialized")) {
            ...
            startActivity(new Intent(com.feifei.testv4.MainActivity.this, AdminLoginActivity.class));
        } else {
            credentialsinitialized = sharedPreferences.getBoolean("initialized", true);
        }

        // Check if bluetooth is turned on. If not, request.
        com.feifei.testv4.Utils.checkBluetooth(bluetoothAdapter, this);
    }
