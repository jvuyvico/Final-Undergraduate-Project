...
public class DatabaseAccess {
    ...
    private static com.feifei.testv4.DatabaseAccess instance;

    private DatabaseAccess(Context context) {
        this.openHelper = new DatabaseOpenHelper(context);
    }

    public static com.feifei.testv4.DatabaseAccess getInstance(Context context) {
        if (instance == null) {
            instance = new com.feifei.testv4.DatabaseAccess(context);
        }
        return instance;
    }
