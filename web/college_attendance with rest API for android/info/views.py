...
from .models import User, Dept, Class, Student, Attendance, Course, Teacher, Assign, AttendanceTotal, time_slots, \
...
#Ito yung main viewset na ginamit for receiving stuff from the Android server
#You guys can check the tutorial na nakalagay sa trello (2 hour and 30 one) for more info. Number 9 siya yung routers and viewsets
...
class UserProfileList(generics.GenericAPIView,mixins.RetrieveModelMixin,mixins.ListModelMixin, mixins.CreateModelMixin, mixins.UpdateModelMixin, mixins.DestroyModelMixin):
